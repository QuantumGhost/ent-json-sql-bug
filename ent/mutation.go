...
import (
	...
	"github.com/QuantumGhost/ent-json-sql-bug/ent/predicate"
...
func (m *UserMutation) SetProperty(s schema.Property) {
	m.property = &s
}

// Property returns the value of the "property" field in the mutation.
func (m *UserMutation) Property() (r schema.Property, exists bool) {
	v := m.property
	if v == nil {
		return
	}
...
// OldProperty returns the old "property" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldProperty(ctx context.Context) (v schema.Property, err error) {
...
func (m *UserMutation) ResetProperty() {
	m.property = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.property != nil {
		fields = append(fields, user.FieldProperty)
	}
	return fields
}
